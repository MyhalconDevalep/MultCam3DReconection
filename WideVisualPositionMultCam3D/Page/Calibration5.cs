...
{
    public partial class Calibration5 : UIPage
    {
        public Calibration5()
        {
            InitializeComponent();
        ...
        private void btn_SelectFile_Click(object sender, EventArgs e)
        {
            ...
            if (DirEx.SelectDirEx("扩展打开文件夹", ref dir))
            {
                ...
                GlobalStaticData.HalconAlgorithmFunction.Calibration_model_Init(0.006, 0.00000345, 0.00000345, width, height, dir + "caltab_240mm.descr", out GlobalStaticData.CameraGroupConfig5.findCoorPairsData.hv_CalibDataID);
        ...
        private async void btn_StarCalibrationCams_Click(object sender, EventArgs e)
        {
            ...
            btn_StarCalibrationCams.Enabled = false;
            btn_SaveCalibration.Enabled = false;
            await Task.Run(() => { GlobalStaticData.HalconAlgorithmFunction.Calibration_mask(dir, ref GlobalStaticData.CameraGroupConfig5.findCoorPairsData.hv_CalibDataID, hWindowControl1.HalconWindow, hWindowControl2.HalconWindow, hWindowControl3.HalconWindow, out hv_Errors); });
            SystemEx.Delay(50);
            if (hv_Errors == null)
            {
