...
{
    public partial class CalibrationAcq3 : UIPage
    {
        private Barrier _barrier = null;


        public CalibrationAcq3()
        {
            InitializeComponent();
        ...
        void Camera1Display(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    isCam1AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "3", "0", $"1_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
        ...
        void Camera2Display(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                {
                    isCam2AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "3", "1", $"2_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
                }
        ...
        void Camera3Display(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                {
                    isCam3AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "3", "2", $"3_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
        ...
        private void Camera1ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam6", "7");
                }
                hWindowControl1.HobjectToHimage(Himage.Clone());
        ...
        private void Camera2ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam7", "8");
                }
                hWindowControl2.HobjectToHimage(Himage.Clone()) ;
        ...
        private void Camera3ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam8", "9");
                }
                hWindowControl3.HobjectToHimage(Himage.Clone() );
        ...
        private void ApplyCamState(bool enable)
        {
            if (enable)
            {
                GlobalStaticData.HIKCamera7?.TriggerMode(0);
                GlobalStaticData.HIKCamera8?.TriggerMode(0);
                GlobalStaticData.HIKCamera9?.TriggerMode(0);

                GlobalStaticData.HIKCamera7.eventRun -= Camera1Display;
                GlobalStaticData.HIKCamera7.eventRun += Camera1Display;
                GlobalStaticData.HIKCamera8.eventRun -= Camera2Display;
                GlobalStaticData.HIKCamera8.eventRun += Camera2Display;
                GlobalStaticData.HIKCamera9.eventRun -= Camera3Display;
                GlobalStaticData.HIKCamera9.eventRun += Camera3Display;
            ...
            {
                GlobalStaticData.HIKCamera7.TriggerMode(1);
                GlobalStaticData.HIKCamera8.TriggerMode(1);
                GlobalStaticData.HIKCamera9.TriggerMode(1);
        ...
        private void ApplyCamSoftState(bool enable)
        {
            if (enable)
            {
                ...
                GlobalStaticData.HIKCamera7.eventRun -= Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera7.eventRun += Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera8.eventRun -= Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera8.eventRun += Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera9.eventRun -= Camera3ContinuousDisplay;
                GlobalStaticData.HIKCamera9.eventRun += Camera3ContinuousDisplay;
            ...
            else
            {
                ...
                CalibrationAcqUiStateHelper.StopContinuousCapture(ref _isRunning, ref _cancellationTokenSource, btn_SaveContinuousStart);
                GlobalStaticData.HIKCamera7.TriggerCamera(0);
                GlobalStaticData.HIKCamera8.TriggerCamera(0);
                GlobalStaticData.HIKCamera9.TriggerCamera(0);
                GlobalStaticData.HIKCamera7.eventRun -= Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera8.eventRun -= Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera9.eventRun -= Camera3ContinuousDisplay;
