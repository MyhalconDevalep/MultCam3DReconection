...
namespace WideVisualPositionMultCam3D.Page
{
    public partial class Calibration3 : UIPage
    {
        ...
        private void btn_SelectFile_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!CalibrationFolderLoader.TryLoad(dir, GlobalStaticData.CameraGroupConfig3, hWindowControl1, hWindowControl2, hWindowControl3, out string warning))
                {
        ...
        private void btn_SaveCalibration_Click(object sender, EventArgs e)
        {
            ...
            {
                if (CalibrationFolderLoader.TrySave(GlobalStaticData.CameraGroupConfig3, 3, out string warning))
                {
