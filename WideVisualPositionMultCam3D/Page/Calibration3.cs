...
{
    public partial class Calibration3 : UIPage
    {
        public Calibration3()
        {
            InitializeComponent();
        ...
        private void btn_SelectFile_Click(object sender, EventArgs e)
        {
            ...
            if (DirEx.SelectDirEx("扩展打开文件夹", ref dir))
            {
                ...
                GlobalStaticData.HalconAlgorithmFunction.Calibration_model_Init(0.006, 0.00000345, 0.00000345, width, height, dir + "caltab_240mm.descr", out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CalibDataID);
        ...
        private async void btn_StarCalibrationCams_Click(object sender, EventArgs e)
        {
            ...
            btn_StarCalibrationCams.Enabled = false;
            btn_SaveCalibration.Enabled = false;
            await Task.Run(() => { GlobalStaticData.HalconAlgorithmFunction.Calibration_mask(dir, ref GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CalibDataID, hWindowControl1.HalconWindow, hWindowControl2.HalconWindow, hWindowControl3.HalconWindow, out hv_Errors); });
            SystemEx.Delay(50);
            if (hv_Errors == null)
            {
        ...
        private void btn_SaveCalibration_Click(object sender, EventArgs e)
        {
            ...
            {
                bool res = GlobalStaticData.HalconAlgorithmFunction.Write_calibration_data(GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CalibDataID, GlobalStaticData.WriteCalibrationPath + @"\Calibration\calibration_data3.cal", out GlobalStaticData.CameraGroupConfig3.worldTransformerData.hv_CamParamData0, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CamPose0, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CamParamData1, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CamPose1, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CamParamData2, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CamPose2, out GlobalStaticData.CameraGroupConfig3.worldTransformerData.hv_World2CamMat0, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_InvertToCamMat0, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_InvertToCamMat1, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_InvertToCamMat2, out GlobalStaticData.CameraGroupConfig3.worldTransformerData.hv_PlanePose, out GlobalStaticData.CameraGroupConfig3.findCoorPairsData.hv_CameraSetupModel, out GlobalStaticData.CameraGroupConfig3.hv_StereoModelIDGroup);
                if (res)
                {
