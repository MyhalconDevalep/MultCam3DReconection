...
{
    public partial class CalibrationAcq5 : UIPage
    {
        ...
        void Camera1Display(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    isCam1AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "5", "0", $"1_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
        ...
        void Camera2Display(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                {
                    isCam2AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "5", "1", $"2_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
                }
        ...
        void Camera3Display(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                {
                    isCam3AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "5", "2", $"3_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
        ...
        private void Camera1ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam12", "11");
                }
                hWindowControl1.HobjectToHimage(Himage.Clone());
        ...
        private void Camera2ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam13", "12");
                }
                hWindowControl2.HobjectToHimage(Himage.Clone()) ;
        ...
        private void Camera3ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam14", "13");
                }
                hWindowControl3.HobjectToHimage(Himage.Clone() );
        ...
        private void ContinuousSave(CancellationToken cancellationToken)
        {
            try
            {
                while (!cancellationToken.IsCancellationRequested)
                {
                    ...
                    GlobalStaticData.HIKCamera13.SoftwareTrigger();
                    GlobalStaticData.HIKCamera14.SoftwareTrigger();
                    GlobalStaticData.HIKCamera15.SoftwareTrigger();
                    // 模拟耗时操作（例如每1秒执行一次）
        ...
        private void ApplyCamState(bool enable)
        {
            if (enable)
            {
                GlobalStaticData.HIKCamera13?.TriggerMode(0);
                GlobalStaticData.HIKCamera14?.TriggerMode(0);
                GlobalStaticData.HIKCamera15?.TriggerMode(0);

                GlobalStaticData.HIKCamera13.eventRun -= Camera1Display;
                GlobalStaticData.HIKCamera13.eventRun += Camera1Display;
                GlobalStaticData.HIKCamera14.eventRun -= Camera2Display;
                GlobalStaticData.HIKCamera14.eventRun += Camera2Display;
                GlobalStaticData.HIKCamera15.eventRun -= Camera3Display;
                GlobalStaticData.HIKCamera15.eventRun += Camera3Display;
            ...
            {
                GlobalStaticData.HIKCamera13.TriggerMode(1);
                GlobalStaticData.HIKCamera14.TriggerMode(1);
                GlobalStaticData.HIKCamera15.TriggerMode(1);
        ...
        private void ApplyCamSoftState(bool enable)
        {
            if (enable)
            {
                ...
                GlobalStaticData.HIKCamera13.TriggerCamera(7);
                GlobalStaticData.HIKCamera14.TriggerCamera(7);
                GlobalStaticData.HIKCamera15.TriggerCamera(7);
                GlobalStaticData.HIKCamera13.eventRun -= Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera13.eventRun += Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera14.eventRun -= Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera14.eventRun += Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera15.eventRun -= Camera3ContinuousDisplay;
                GlobalStaticData.HIKCamera15.eventRun += Camera3ContinuousDisplay;
            ...
            else
            {
                ...
                CalibrationAcqUiStateHelper.StopContinuousCapture(ref _isRunning, ref _cancellationTokenSource, btn_SaveContinuousStart);
                GlobalStaticData.HIKCamera13.TriggerCamera(0);
                GlobalStaticData.HIKCamera14.TriggerCamera(0);
                GlobalStaticData.HIKCamera15.TriggerCamera(0);
                GlobalStaticData.HIKCamera13.eventRun -= Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera14.eventRun -= Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera15.eventRun -= Camera3ContinuousDisplay;
