...
{
    public partial class CalibrationAcq2 : UIPage
    {
        ...
        void Camera1Display(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    isCam1AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "2", "0", $"1_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
        ...
        void Camera2Display(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                {
                    isCam2AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "2", "1", $"2_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
                }
        ...
        void Camera3Display(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                {
                    isCam3AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "2", "2", $"3_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
        ...
        private void Camera1ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam3", "4");
                }
                hWindowControl1.HobjectToHimage(Himage.Clone());
        ...
        private void Camera2ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam4", "5");
                }
                hWindowControl2.HobjectToHimage(Himage.Clone());
        ...
        private void Camera3ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam5", "6");
                }
                hWindowControl3.HobjectToHimage(Himage?.Clone());
        ...
        private void ApplyCamState(bool enable)
        {
            if (enable)
            {
                GlobalStaticData.HIKCamera4?.TriggerMode(0);
                GlobalStaticData.HIKCamera5?.TriggerMode(0);
                GlobalStaticData.HIKCamera6?.TriggerMode(0);

                GlobalStaticData.HIKCamera4.eventRun += Camera1Display;
                GlobalStaticData.HIKCamera5.eventRun += Camera2Display;
                GlobalStaticData.HIKCamera6.eventRun += Camera3Display;
            ...
            {
                GlobalStaticData.HIKCamera4.TriggerMode(1);
                GlobalStaticData.HIKCamera5.TriggerMode(1);
                GlobalStaticData.HIKCamera6.TriggerMode(1);
        ...
        private void ApplyCamSoftState(bool enable)
        {
            if (enable)
            {
                ...
                GlobalStaticData.HIKCamera4.eventRun += Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera5.eventRun += Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera6.eventRun += Camera3ContinuousDisplay;
            ...
            else
            {
                ...
                GlobalStaticData.HIKCamera4.TriggerCamera(0);
                GlobalStaticData.HIKCamera5.TriggerCamera(0);
                GlobalStaticData.HIKCamera6.TriggerCamera(0);
                GlobalStaticData.HIKCamera4.eventRun -= Camera1ContinuousDisplay;
                GlobalStaticData.HIKCamera5.eventRun -= Camera2ContinuousDisplay;
                GlobalStaticData.HIKCamera6.eventRun -= Camera3ContinuousDisplay;
                btn_SaveContinuousStart.Enabled = false;
