...
{
    public partial class Calibration6 : UIPage
    {
        public Calibration6()
        {
            InitializeComponent();
        ...
        private async void btn_StarCalibrationCams_Click(object sender, EventArgs e)
        {
            ...
            btn_StarCalibrationCams.Enabled = false;
            btn_SaveCalibration.Enabled = false;
            await Task.Run(() => { GlobalStaticData.HalconAlgorithmFunction.Calibration_mask(dir, ref GlobalStaticData.CameraGroupConfig6.findCoorPairsData.hv_CalibDataID, hWindowControl1.HalconWindow, hWindowControl2.HalconWindow, hWindowControl3.HalconWindow, out hv_Errors); });
            SystemEx.Delay(50);
            if (hv_Errors == null)
            {
