...
{
    public partial class CalibrationAcq4 : UIPage
    {
        ...
        void Camera1Display(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    isCam1AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "4", "0", $"1_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
        ...
        void Camera2Display(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                {
                    isCam2AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "4", "1", $"2_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
                }
        ...
        void Camera3Display(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                {
                    isCam3AcqSave = false;
                    WriteImgaesHelper.WriteCalibrationImages(Himage.Clone(), "4", "2", $"3_{GlobalStaticData.UpdataBingdingData.CalibrationIndex1}");
                    _barrier.SignalAndWait();
        ...
        private void Camera1ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam1)
            {
                ...
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam9", "10");
                }
                hWindowControl1.HobjectToHimage(Himage.Clone());
        ...
        private void Camera2ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam2)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam10", "11");
                }
                hWindowControl2.HobjectToHimage(Himage.Clone()) ;
        ...
        private void Camera3ContinuousDisplay(HObject Himage)
        {
            lock (_lockCam3)
            {
                ...
                if (_IsContinuousAcqSaveEnable)
                {
                    WriteImgaesHelper.WriteAllImages(Himage.Clone(), "Cam11", "12");
                }
                hWindowControl3.HobjectToHimage(Himage.Clone() );
        ...
        private void ApplyCamState(bool enable)
        {
            if (enable)
            {
                GlobalStaticData.HIKCamera10?.TriggerMode(0);
            ...
            {
                GlobalStaticData.HIKCamera10.TriggerMode(1);
                GlobalStaticData.HIKCamera11.TriggerMode(1);
                GlobalStaticData.HIKCamera12.TriggerMode(1);
