...
{
    public partial class Calibration1 : UIPage
    {
        ...
        private async void btn_StarCalibrationCams_Click(object sender, EventArgs e)
        {
            ...
            btn_StarCalibrationCams.Enabled = false;
            btn_SaveCalibration.Enabled = false;
            await Task.Run(()=> { GlobalStaticData.HalconAlgorithmFunction.Calibration_mask(dir, ref GlobalStaticData.CameraGroupConfig1.findCoorPairsData.hv_CalibDataID, hWindowControl1.HalconWindow, hWindowControl2.HalconWindow, hWindowControl3.HalconWindow, out hv_Errors); });
            SystemEx.Delay(50);
            if(hv_Errors==null)
            {
